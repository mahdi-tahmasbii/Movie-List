        ...
        <div className="mx-auto max-w-6xl sm:px-6 lg:px-8">
          ...
          <div className="mt-8 overflow-hidden bg-white shadow dark:bg-gray-800 sm:rounded-lg">
            <div className="grid grid-cols-1 md:grid-cols-2">
              ...
              <div className="border-t border-gray-200 p-6 dark:border-gray-700 md:border-l md:border-t-0">
                <div className="flex items-center">
                  <svg
                    fill="none"
                    stroke="currentColor"
              ...
              <div className="border-t border-gray-200 p-6 dark:border-gray-700 md:border-l">
                <div className="flex items-center">
                  <svg
                    fill="none"
                    stroke="currentColor"
            ...
            <div className="text-center text-sm text-gray-500 sm:text-left">
              <div className="flex items-center">
                <svg
                  ...
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  className="-mt-px h-5 w-5 text-gray-400"
                >
                ...
                <svg
                  ...
                  strokeWidth="2"
                  viewBox="0 0 24 24"
                  className="-mt-px ml-4 h-5 w-5 text-gray-400"
                >
